...
function BannerHome({ onsearch }) {
  ...
  return (
    <div className="relative overflow-hidden pt-16">
      ...
      <div className='relative z-10 mt-8 sm:mt-10 lg:mt-12 max-w-7x1 mx-auto
          ...
          <div className='text-center md:text-left'>
            <div className={bannerStyles.tag}>
              <span className='flex items-center text-sm sm:text-base'>
                <FiTruck className='mr-2' /> Free Deliver On Orders
                Above ₹199
              </span>
            </div>
            ...
            <p className={bannerStyles.paragraph}>
              ...
              delivered in just 10 minutes ⏱️
            </p>

            <form onSubmit={handleSubmit} className={bannerStyles.form}>

              <input type="text" value={searchTerm} onChange={handleSearch}
                className={bannerStyles.input} placeholder="Search Fruits, Vegetables And More..." />
